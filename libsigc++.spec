...
Source0  : https://download.gnome.org/sources/libsigc++/3.0/libsigc++-3.0.6.tar.xz
...
%prep
%setup -q -n libsigc++-3.0.6
cd %{_builddir}/libsigc++-3.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611159535
...
cp %{_builddir}/libsigc++-3.0.6/COPYING %{buildroot}/usr/share/package-licenses/libsigc++/49d4c0ce1a16601f1e265d446b6c5ea6b512f27c
